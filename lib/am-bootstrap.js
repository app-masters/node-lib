...
module.exports = function (app, envs, packag) {
    ...
    if (!envs.development)
        throw new Error("You shold pass the complete 'envs' objects as second paramater to amBootstrap, not more 'config'. Bootstrap will load the right env config.");
