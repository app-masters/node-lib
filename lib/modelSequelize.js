...
class ModelSequelize extends Model {
    static setup (sequelize, modelName, schema, itemInstance, relationArray) {
        if (!modelName) {
    ...
    static returnItemInstance (item) {
    ...
    static create (obj) {
        return this.model.create(obj).then(this.returnItemInstance);
    }
    ...
    static find (where, include, order) {
        ...
        return this.model.findAll(options).then(items => items.map(this.returnItemInstance));
    }
    ...
    static findById (id, include) {
        ...
        return this.model.findById(id, options).then(this.returnItemInstance);
    }
    ...
    static findOne (where, include) {
        ...
        return this.model.find(options).then(this.returnItemInstance);
    }
