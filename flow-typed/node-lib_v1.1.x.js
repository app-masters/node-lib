...
declare class NodeLib$ModelSequelize<Schema, Options>{
  ...
  static create (obj: {...Schema}): Promise<$Exact<Schema> & $Exact<Options>>;
  static find (where: {...Schema}, include: ?string, order: ?string): Promise<?Array<$Exact<Schema> & $Exact<Options>>>;
  static findById (id: ObjectId, include: ?string): Promise<?($Exact<Schema> & $Exact<Options>)>;
  static findOne (where: {...Schema}, include: ?string): Promise<?$Exact<Schema> & $Exact<Options>>;
